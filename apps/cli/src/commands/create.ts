...
export const createCommand = new Command("create")
  ...
  .option("--verse-provider <id>", "Use a different provider for Verse generation")
  .option("--verse-model <id>", "Use a different model for Verse generation")
  .option("--verse-ollama-url <url>", "Use a different Ollama-compatible URL for Verse generation")
