# UEFN Import Guide — Compact Solo Tycoon

## Step 1: Create UEFN Project
1. Open UEFN and create a new project
2. Name it "Compact Solo Tycoon"
...
- Coin Loop (`zone_coin_loop`)
- Automation Yard (`zone_worker_yard`)
3. Place shop, upgrade, and gate devices in progression zones:
- Upgrade Kiosk (`zone_upgrade`, shop)
- Bonus Alcove (`zone_bonus`, unlock_gate)
...
Income sources:
- Coin Collection: 12/per_action in `zone_coin_loop`
- Auto Collector: 24/per_second in `zone_upgrade`

Purchases/upgrades:
- Coin Upgrade: 90 coins (upgrade)
- Auto Collector: 90 coins (unlock)
- Quick Rebirth: 320 coins (prestige)
